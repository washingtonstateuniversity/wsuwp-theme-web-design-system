...
<div class="wsu-g-container">
	<?php get_template_part( 'demo/template-parts/site-nav-vertical--open', get_post_type() ); ?>
	<!-- SITE WRAPPER:START -->
	<div class="wsu-s-wrapper">
		...
		<div class="wsu-s-main-container">
			...
			<?php get_template_part( 'demo/template-parts/site-hero-banner-overlay', get_post_type() ); ?>
